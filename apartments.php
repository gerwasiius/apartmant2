...
<main class="container mx-auto px-4 py-10">
  <!-- Page title -->
  <h1 class="text-3xl font-semibold mb-8">Our Apartments</h1>
        ...
        <div class="mb-3">
          <div class="flex items-center gap-2 mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-mediterranean-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3M4 11h16M5 21h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1M6 5H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2"/>
            </svg>
            <span class="font-medium">Dates</span>
          </div>
          <label for="dateRange" class="sr-only">Dates</label>
          <!-- IMPORTANT: same id as on homepage so calendar.js picks it up -->
          <input id="dateRange" class="input-sand w-full rounded-md px-3 py-2 text-sm" placeholder="From — To" />
        </div>

        <!-- Guests -->
        <div class="mb-4">
          <div class="flex items-center gap-2 mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-mediterranean-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <select id="guests" class="input-sand w-full rounded-md px-3 py-2 text-sm">
          ...
          <div class="rounded-xl border border-mediterranean-sand overflow-hidden bg-white">
            <div class="grid md:grid-cols-[300px_1fr] gap-0">
              ...
              <div class="relative aspect-[4/3] md:aspect-auto">
                <img
                  src="<?php echo htmlspecialchars($a['images'][0]['url']); ?>"
                  alt="<?php echo htmlspecialchars($a['images'][0]['alt'] ?? $a['name']); ?>"
              ...
              <div class="p-6 flex flex-col gap-3">
                ...
                <div class="flex items-center gap-4 text-sm text-gray-800">
                  <div class="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-mediterranean-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M2 12h20M2 12l4 8h12l4-8M6 12l2-6h8l2 6"/></svg>
                    <?php echo (int)$a['beds']; ?> beds
                  </div>
                  <div class="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-mediterranean-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 10h18M6 10V6a3 3 0 0 1 3-3h6a3 3 0 0 1 3 3v4"/><path d="M6 10v7a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-7"/></svg>
                    <?php echo (int)$a['baths']; ?> bath
                  </div>
                  <div class="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-mediterranean-blue" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
