<section class="cta-wrap">
  <div class="container">
    ...
    <div class="mt-6 flex justify-center gap-4">
      <a class="btn btn-primary" href="<?php echo htmlspecialchars(url('pages/apartments.php')); ?>">
        <?= htmlspecialchars(t('cta.view_all')) ?>
      </a>
      <a class="btn btn-ghost" href="<?php echo htmlspecialchars(url('pages/contact.php')); ?>">
